...
class TransferPolicy
{
    ...
    {
        return $user->hasPermission('browse_transfers');
    }
    ...
    {
        return $user->hasPermission('create_transfers');
    }
    ...
    {
        return $user->hasPermission('edit_transfers');
    }
    ...
    {
        return $user->hasPermission('delete_transfers');
    }
