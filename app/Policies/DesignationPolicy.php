...
class DesignationPolicy
{
    ...
    {
        return $user->hasPermission('browse_designations');
    }
    ...
    {
        return $user->hasPermission('create_designations');
    }
    ...
    {
        return $user->hasPermission('edit_designations');
    }
    ...
    {
        return $user->hasPermission('delete_designations');
    }
