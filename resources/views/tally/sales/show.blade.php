...
<header class="d-flex justify-content-between align-items-center mb-4">
    <h5>Sale</h5>
    <a href="{{ route('tally.sales.index') }}" class="btn btn-sm btn-secondary">Back</a>
</header>
            ...
            <table class="table" style="min-width: 60rem;">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            {{ $sale->voucher_date->format('d M, Y') }}
                        </td>
                    </tr>
                    <tr>
...
<div class="card shadow-sm border-0 mb-4">
    ...
    <div class="card-body p-0">
       @if (isset($sale->buyer_address_list))  
        <section class="table-responsive mb-4">
            <table class="table" style="min-width: 60rem;">
                <tbody>
                    @foreach ($sale->buyer_address_list as $buyer)   
                        <tr>
...
<div class="card shadow-sm border-0 mb-4">
    ...
    <div class="card-body p-0">
        ...
        @if (isset($sale->inventories_list))  
        <section class="table-responsive mb-4">
            <table class="table" style="min-width: 60rem;">
                <thead>
                    <tr>
                ...
                <tbody>
                    @foreach ($sale->inventories_list as $inventory)
                        <tr>
...
<div class="card shadow-sm border-0 mb-4">
    ...
    <div class="card-body p-0">
        ...
        @if (isset($sale->ledger_entries_list))  
        <section class="table-responsive mb-4">
            <table class="table" style="min-width: 60rem;">
                <thead>
                    <th>Ledger Name</th>
                ...
                <tbody>
                    @foreach ($sale->ledger_entries_list as $item)
