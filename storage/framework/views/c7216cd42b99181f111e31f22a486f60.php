...
<a href="<?php echo e(route('customers.show', ['customer' => $customer])); ?>" class="btn btn-sm text-primary"><i class="feather icon-eye"></i></a>
<?php endif; ?>

<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $customer)): ?>
<a href="<?php echo e(route('customers.edit', ['customer' => $customer])); ?>" class="btn btn-sm text-primary"><i class="feather icon-settings"></i></a>
<?php endif; ?>

<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete', $customer)): ?>
<form class="d-inline-block" action="<?php echo e(route('customers.destroy', ['customer' => $customer])); ?>" method="POST"
