...
<header class="d-flex justify-content-between align-items-center mb-4">
  <h5>Leaves</h5>
  <a href="<?php echo e(route('leaves.create')); ?>" class="btn btn-primary">Leave</a>
</header>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.datatable','data' => ['id' => 'leaves','columns' => $columns]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'leaves','columns' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($columns)]); ?>
