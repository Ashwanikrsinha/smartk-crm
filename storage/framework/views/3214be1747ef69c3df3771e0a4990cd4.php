    ...
    <div class="d-flex align-items-center">
      <div class="dropdown shadow-sm me-2">
        ...
        <div class="dropdown-menu dropdown-menu-end shadow-sm border-0" aria-labelledby="settings-dropdown">
            <a href="<?php echo e(route('departments.index')); ?>" class="dropdown-item">Departments</a>
        </div>
      </div>

      <a href="<?php echo e(route('employees.create')); ?>" class="btn btn-primary">Employee</a>
    </div>
  <?php endif; ?>
</header>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.datatable','data' => ['id' => 'employees','columns' => $columns]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'employees','columns' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($columns)]); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Data\smartk-crm\resources\views/employees/index.blade.php ENDPATH**/ ?>