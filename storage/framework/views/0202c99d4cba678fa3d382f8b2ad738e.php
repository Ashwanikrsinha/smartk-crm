  ...
  <div class="d-flex align-items-center">
    <div class="dropdown shadow-sm me-2">
      ...
      <div class="dropdown-menu dropdown-menu-end shadow-sm border-0" aria-labelledby="settings-dropdown">
          <a href="<?php echo e(route('customer-types.index')); ?>" class="dropdown-item">Customer Types</a>
    ...
    <a href="<?php echo e(route('customers.create')); ?>" class="btn btn-primary">Customer</a>
  </div>
  <?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.datatable','data' => ['id' => 'customers','columns' => $columns]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'customers','columns' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($columns)]); ?>
