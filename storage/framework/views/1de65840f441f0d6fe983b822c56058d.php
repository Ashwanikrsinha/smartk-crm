...
style="z-index: 90;">
    ...
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="dropdown">
            ...
            <small class="mb-1 pe-2 text-muted"><?php echo e(Str::limit(auth()->user()->username, '15')); ?></small>
            ...
            <div class="dropdown-menu dropdown-menu-end shadow-sm border-0" aria-labelledby="logout-dropdown">
                <a href="<?php echo e(route('users.profile.show', ['user' => auth()->id() ])); ?>" class="dropdown-item">Profile</a>
...
</div><?php /**PATH D:\Data\smartk-crm\resources\views/partials/top-nav.blade.php ENDPATH**/ ?>