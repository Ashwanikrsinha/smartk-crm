...
<div class="bg-white rounded shadow-sm p-4 mb-4">
    ...
    <div class="row">
        ...
        <input type="hidden" name="lead_source_id" id="lead-source"
            value="<?php echo e($invoice->customer->lead_source_id ?? old('lead_source_id')); ?>">
        <div class="col-lg-3 mb-3">
            <label class="form-label">Lead Source</label>
            <input type="text" disabled name="lead_source_name" class="form-control" id="lead-source-name"
                value="<?php echo e(isset($invoice) ? $invoice->lead_source_name : old('lead_source_name')); ?>"
        ...
        <div class="col-lg-6 mb-3">
            ...
            <input type="text" name="address" class="form-control" id="school-address"
                value="<?php echo e(isset($invoice) ? $invoice->address : old('address')); ?>" placeholder="Full address">
        </div>
        ...
        <div class="col-lg-3 mb-3">
            ...
            <input type="text" name="state" class="form-control" id="school-state"
                value="<?php echo e(isset($invoice) ? $invoice->customer->state : old('state')); ?>" placeholder="State">
        </div>
        ...
        <div class="col-lg-3 mb-3">
            ...
            <input type="text" name="city" class="form-control" id="school-city"
                value="<?php echo e(isset($invoice) ? $invoice->customer->city : old('city')); ?>" placeholder="City">
        </div>
...
<div class="bg-white rounded shadow-sm p-4 mb-4">
    ...
    <div class="row">
        <div class="col-lg-12 mb-3">
            ...
            <textarea name="remarks" class="form-control" rows="3" placeholder="Any notes or special instructions..."><?php echo e(isset($invoice) ? $invoice->remarks : old('remarks')); ?></textarea>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12 mb-3">
            ...
            <textarea name="terms" readonly class="form-control" rows="6"
                placeholder="Payment terms, delivery conditions..."><?php echo e(isset($invoice)
                    ? $invoice->terms
