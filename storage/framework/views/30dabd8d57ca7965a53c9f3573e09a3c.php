...
<header class="d-flex justify-content-between align-items-center mb-4">
  <h5>Transports</h5>
  <a href="<?php echo e(route('transports.create')); ?>" class="btn btn-primary">Transport</a>
</header>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.datatable','data' => ['id' => 'transports','columns' => $columns]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'transports','columns' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($columns)]); ?>
...
<script>
  $(document).ready(() => {
        ...
        $('table#transports').DataTable({
             ...
             serverSide: true,
             order: [[0,'desc']],
             ajax: '<?php echo e(route("transports.index")); ?>',
             columns: [
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Data\smartk-crm\resources\views/transports/index.blade.php ENDPATH**/ ?>